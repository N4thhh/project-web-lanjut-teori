            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('admin.layanan.create') }}"
                       class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center transition-colors duration-200 shadow-lg shadow-blue-600/20">
                                ...
                                <tr class="bg-white hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 flex justify-center space-x-2">
                                        ...
                                        <form action="{{ route('admin.layanan.destroy', $service->id) }}"
                                              method="POST"
                                              onsubmit="return confirm('Apakah Anda yakin ingin menghapus layanan &quot;{{ $service->nama_layanan }}&quot;? Data yang dihapus tidak dapat dikembalikan.');">
                                            @csrf
                                            @method('DELETE')
